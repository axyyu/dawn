...
&nbsp;
  ...
  this.extract = function(params, callback) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (params.text &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!params.html)</span> { <span class="cstat-no" title="statement not covered" >params.html = params.text; <span class="cstat-no" title="statement not covered" ></span>delete(params.text); </span>}
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jul 29 2015 17:09:59 GMT+0100 (IST)</div>
</div>
